...
class TDViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundView = UIImageView(image: UIImage(named: "iPhonePinkBeachWallpaper.png"))
...
// MARK: - UI bits and pieces 

//        tdBarButton.image = UIImage(named: GloballyUsed.burgerMenuImage)?.withRenderingMode(.alwaysOriginal)
